...
const _tourSteps = [
  ...
  _TourStep(
    title: 'Сметы и объекты',
    body:
        'Во вкладке «Сметы» хранятся предложения клиентам. Переключатель «Объекты» открывает внутренний учёт строительства: расходы, поступления и прибыль.',
    action: 'Откройте объект, чтобы добавлять операции и выгружать отчёт.',
